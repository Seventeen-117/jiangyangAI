...
public class DataCalculationApplication {
    ...
    private static void setupSystemProperties() {
        ...
        System.out.println("系统属性已设置，条件评估报告已禁用，Seata配置验证器已禁用");
    }
    
    /**
     * 设置Seata禁用系统属性
     */
    private static void setupSeataDisableProperties() {
        ...
        System.out.println("Seata禁用配置已设置");
    }
